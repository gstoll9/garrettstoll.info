  ...
  const main = (
    <div>
      ...
      <h4>Lagrange Interpolation</h4>
        ...
        <p><b>The Aitken Method</b> efficiently achieves the Lagrange interpolation by performing a sequence of linear interpolations.</p>
        <BlockMath math="f_{i\cdots j} = \frac{x - x_j}{x_i - x_j} f_{i\cdots j-1} + \frac{x - x_i}{x_j - x_i} f_{i+1\cdots j}" />
        <CodeBlock codeMap={{
