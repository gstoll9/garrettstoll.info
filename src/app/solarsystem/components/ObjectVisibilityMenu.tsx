...
const REGION_GROUPS: { label: string; bodies: string[]; color: string }[] = [
  { label: 'Sun', bodies: ['Sun'], color: SUN_HEADER_COLOR },
  { label: 'Inner Planets', bodies: innerPlanetNames, color: REGION_COLORS.inner },
  { label: 'Asteroid Belt', bodies: ['Asteroid Belt', ...beltDwarfNames], color: REGION_COLORS.asteroidBelt },
...
function RegionGroup({ label, bodies, color, hiddenBodies, toggleBody, setBodiesVisible }: {
  label: string;
  bodies: string[];
  color: string;
  hiddenBodies: Set<string>;
